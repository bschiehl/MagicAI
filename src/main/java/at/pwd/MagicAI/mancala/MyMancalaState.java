 ...
 */
public class MyMancalaState extends MancalaState {
    /**
     ...
     */
    public MyMancalaState(MyMancalaBoard board) {
    ...
    @Override
    public State copy() {
        return new MyMancalaState(this);
    }
}
